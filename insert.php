              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" method='POST'>
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                      <input type="password" name="pswrd" id="form3Example4c" class="form-control" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                      <input type="text" name="adrs" id="form3Example1c" class="form-control" />
...
if(isset($_POST['register'])){
    ...
    $query = mysqli_query($con, "INSERT INTO registers(Name, email, Password, Address) VALUES('$name', '$email', '$pswrd', '$adress')");
